    ...
    <style>
        ...
        *,
        ...
        html {
            ...
            -webkit-tap-highlight-color: transparent background-color: #d09011;
        }

        body {
            margin: 0;
            line-height: inherit background-color: #d09011;
        }
...
<body class="font-sans antialiased dark:text-white/50" style="background-color: #d09011;">
    <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <div id="fade-wrapper" class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">

                    @if (Route::has('login'))
                    <nav class="-mx-3 flex flex-1 justify-center gap-1 lg:col-start-2">
                        @auth
                        <a
                            href="{{ url('/dashboard') }}"
                        ...
                        <a
                            ...
                            <span id="heartbeat-wrapper" class="inline-block">
                                <img id="background" class="h-16 w-auto rounded-full zoom-in" src="drawable\logos.jpeg" alt="Logo">
                            </span>
                        </a>
                        <script>
                            window.addEventListener('DOMContentLoaded', function() {
                                const img = document.getElementById('background');
                                const wrapper = document.getElementById('heartbeat-wrapper');
